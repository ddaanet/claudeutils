"""User configuration for claudeutils.

Reads config from ~/.config/claudeutils/config.toml (or platform equivalent).
"""
...
CONFIG_DIR = Path(platformdirs.user_config_dir("claudeutils"))
