...
def test_task_agent_embeds_outline(
...
def test_task_agent_outline_from_file(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_task_agent_outline_section_priority(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_task_agent_outline_missing(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
