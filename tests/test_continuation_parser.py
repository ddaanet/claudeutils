"""Unit tests for continuation parser (userpromptsubmit-shortcuts.py Tier 3).
...
class TestModeSingleSkill:
    ...
    def test_handoff_with_commit_flag_in_middle(self) -> None:
        ...
        result = parse_continuation('/handoff --no-learnings --commit --force', registry)
...
class TestModeMultiLine:
    """Tests for Mode 3: Multi-line list with 'and\\n- /skill' pattern."""
