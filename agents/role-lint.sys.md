...
When making multiple edits to the same file, edit sequentially to avoid line number drift. Insert bottom-to-top so earlier insertions don't shift later targets.
