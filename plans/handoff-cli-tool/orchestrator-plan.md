...
- step-4-5-test.md | Phase 4 | sonnet | 30 | TEST
- step-4-5-impl.md | Phase 4 | sonnet | 30 | IMPLEMENT
...
- step-4-7-impl.md | Phase 4 | sonnet | 30 | IMPLEMENT | PHASE_BOUNDARY
...
- step-7-1-impl.md | Phase 7 | sonnet | 30 | IMPLEMENT
- step-7-2-test.md | Phase 7 | sonnet | 30 | TEST
- step-7-2-impl.md | Phase 7 | sonnet | 30 | IMPLEMENT
- step-7-3-test.md | Phase 7 | sonnet | 30 | TEST
- step-7-3-impl.md | Phase 7 | sonnet | 30 | IMPLEMENT
- step-7-4-test.md | Phase 7 | sonnet | 30 | TEST
- step-7-4-impl.md | Phase 7 | sonnet | 30 | IMPLEMENT | PHASE_BOUNDARY
...
- IN: Stdin parsing, session.md writes, committed detection, state caching, diagnostics.
...
- IN: End-to-end tests with real git repos via `tmp_path`. Verifies complete pipelines through CLI entry points.
