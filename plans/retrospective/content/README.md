# Retrospective: Blog Raw Materials

Evidence bundles for the agentic programming retrospective blog post. Sep 2025–Mar 2026, 16 repos.

## Reading Order

1. **`synthesis.md`** — Single narrative overview combining all evidence
2. **Topic bundles** — Per-topic evidence (git timeline, session excerpts, inflection points)
3. **Cross-cutting** — Connections, patterns, narrative arcs
...
| `cross-topic-connections.md` | Shared commits/sessions, recurring failure patterns, unified timeline, blog arcs |
