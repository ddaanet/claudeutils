...
**But**: `communication.weak.md` contains ~15 rules. How do these distribute to
sections?
...
- [RULE] Wait for explicit instruction ... (13 more rules)

## GUIDELINES

### Tool Batching Module (8 rules)

- [RULE] Batch reads when needed soon ... (7 more rules)
```
...
- ⚠️ Role config semantics change: `communication: tier1` means "include tier1 rules
  from communication"
...
- [RULE:T2] Ask clarifying questions if requirements unclear ... (more T2 rules)

- [RULE:T3] Complete assigned task then stop
- [RULE:T3] No scope creep beyond task boundaries ... (more T3 rules)
```
...
2. **Should modules be split/merged?**
   - Example: `checkpoint-obedience` splits to `checkpoint-insertion` +
