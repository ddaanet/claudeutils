...
## Cycle 6.1: Frontmatter and file structure
...
## Cycle 6.2: Mode A implementation (single-task worktree)
...
## Cycle 6.3: Mode B implementation (parallel group detection)
...
## Cycle 6.4: Mode C implementation (merge ceremony)
...
## Cycle 6.5: D+B hybrid tool anchors and error communication polish
