...
## Available Tools
1. **Task** - Launch specialized agents (general-purpose, statusline-setup, Explore, Plan, claude-code-guide)
...
- When NOT to use Task tool: specific file reads, specific class definitions, searches in 2-3 files
